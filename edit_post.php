  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <div class="container-fluid">
        ...
        ";
          ...
          <div class="col-sm-7 col-lg-8" style="margin-left: 50px; margin-top: 50px">
        <div id="timeline">
    			<?php
            ...
            <div class="form-group input-group">
    				<input class="form-control" type="text" name="title" value="<?php echo $post_title;?>" size="82" required="required"><br/>
          </div>
          <div class="form-group ">
    				<textarea class="form-control" cols="83" rows="4" name="content" value=" <?php echo $post_con; ?>"></textarea><br/>
          </div>
    				<select class="form-group form-control" style="color:black" name="topic">
