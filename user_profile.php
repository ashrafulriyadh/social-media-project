...
<html lang="en">
 ...
 <div>
  ...
  <a class="navbar-brand font-weight-bolder" href="home.php">Uits Society</a>
    ...
    <form class="form-inline my-2 my-lg-0" method="get" action="results.php" >
      ...
      <button class="btn btn-dark my-2 my-sm-0" type="submit" name="search" value="Search">Search</button>
        ...
        ";
          ?>
    		<div id="user_p">
    			<form action="home.php?id=<?php echo $user_id;?>" style = "margin-left : 80px;margin-top : 110px;"method = "post" id="f">
